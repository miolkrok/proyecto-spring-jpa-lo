...
public class PacienteRepoImpl implements IPacienteRepo{
	...
	public void insertarPaciente(Paciente paciente) {
		...
		Object[] datosAInsertar=new Object[] {paciente.getId(),paciente.getNombre(),
				paciente.getApellido(),paciente.getEdad()};
	...
	public void actualizarPaciente(Paciente paciente) {
		// update paciente SET id=1,nombre= 'alexander',apellido= 'laguapillo',edad =23 where id=1
